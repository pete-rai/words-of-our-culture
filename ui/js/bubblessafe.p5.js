...
const CLR_BACK = [220, 220, 220];  // background world color
const CLR_TEXT = [  0,   0, 128];  // bubble text color
...
const VIZ_ALPHA_DEPTH  = 0.70;  // >0 & <=1  - depth of fading of small bubbles, bigger num = more fading
...
function Bubbles (_source, _parent, _onselect, _tiptext)
{
    ...
    this.setup = function ()
    {
        ...
        loop ();  // at the end of setup - start looping
    }
    ...
    this.select = function ()
    {
        ...
        {
            this.onselect (this.last_over.substr (1), this.bubbles [this.last_over].data);  // callback
        }
    }
