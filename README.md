...
You can find a very detailed explanation of log-likelihood over on it's [Wikipedia page](https://en.wikipedia.org/wiki/Likelihood_function#Log-likelihood). But, as with a lot of things on Wikipedia, you may find the description there too technical and hence hard to follow. A more understandable explanation can be found over at the computer department of [Lancaster University](http://ucrel.lancs.ac.uk/llwizard.html). Here [Dr Paul Rayson](http://www.lancaster.ac.uk/staff/rayson/) provides a much more accessible description of the technique and how to apply it. In fact, his article is the basis of [the implementation](https://github.com/pete-rai/words-of-our-culture/blob/master/ui/lib/loglikelihood.php) that I used within this project.
